      ...
      <div>
        ...
        <div className="bg-gradient-to-r from-primary-600 to-primary-800 text-white rounded-xl px-4 py-4 mb-6">
            <div className='flex justify-between items-start'>
                ...
                <div> <Button size="small" text={<PlusIcon className='h-6 text-primary-600'/>} bgColor='white'/> </div>
            </div>
            <div className='font-semibold text-8xl text-center py-4'>1</div>
            <div className='flex justify-end'>
                <div>  <Button size="small" text={<MinusIcon className='h-6 text-primary-600'/>} bgColor='white'/>  </div>
            </div>
        </div>
